        ...
        <tr>
            <td style="font-family: Inter, sans-serif; font-size: 14px; vertical-align: top;">
                <p
                    ...
                    ¡Felicidades, <strong>{{ $fullname }}</strong> </p>
                <p
                    style="font-family: Inter, sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                    Tenemos el placer de informarte que la pieza gráfica que creaste para la vacante
                    "<strong>{{ $position }}</strong>" ha sido aprobada.</p>
                ...
                <p
                    style="font-family: Inter, sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                    Ahora puedes utilizarla y compartirla en tus redes sociales para llegar a más personas interesadas en
                    esta vacante.</p>
                <p
                    style="font-family: Inter, sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
