<template>
    <Head title="Crear nueva vacante" />

    <Header title="Marketing / Crear nueva vacante">
        <p>
            Crear nueva vacante, por favor completa los campos requeridos
            marcados con (*).
        </p>
    </Header>
...
let getAllCitiesById = async (event) => {
