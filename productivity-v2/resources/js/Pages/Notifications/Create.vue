<template>
    ...
    <Header title="Administración / Crear notificación">
        <p>
            Para crear una nueva notificación, por favor completa los campos
            marcados con (*), ya que son obligatorios.
        </p>
    </Header>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-1">
                <div>
                    <label
                        ...
                        >Nombre de la notificación *</label
                    >
                    <input
                        type="text"
                        id="name"
